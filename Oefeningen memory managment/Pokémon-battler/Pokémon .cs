...
namespace Pokémon_battler
{
    class Pokémon
    {
        ...
        //Statistieken prop
        public double Average_Base {
            get 
            {
                return (_HP_Base + _Attack_Base + _Defense_Base + _SpecialAttack_Base + _SpecialDefense_Base + _Speed_Base) / 6.0;
            } 
        }
        public double Average_Full
        {
            get
            {
                return (HP_Full + Attack_Full + Defense_Full + SpecialAttack_Full + SpecialDefense_Full + Speed_Full) / 6.0;
            }
        }
        ...
        public void ShowInfo()
        {
            ...
            Console.WriteLine($"\n\t* Average = {Average_Base}");
            Console.WriteLine($"\t* Total = {Total_Base}");
